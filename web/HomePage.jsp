...
<html>
    ...
    <body>
        ...
        <div class="login-wrapper">
            <form action="loginforadmin" method="POST" class="form">
                <h2>ADMIN LOGIN</h2>
                <div class="input-group">
                <input type="text" name="loginuserid" id="loginuserid" required>
        ...
        <div id="cu" class="contactus">
            ...
            <br>
            <p><font color="black"> Emergency Number:</font> 7882301346 </p>
            <br>
        </div>
